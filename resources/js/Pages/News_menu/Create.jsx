...
const Create = ({auth, menus}) => {
  ...
  const handleSubmit = (e) => {
    ...
    post(route('news-menus.store'), {
      onSuccess: () => {
        ...
        toast.success('News Menu has been created successfully');
      },
      onError: (errors) => {
  ...
  return (
    <AuthenticatedLayout 
          user={auth.user} 
          header={<h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200">Create News Menu</h2>}
        >
          <Head title="Create News Menu" />
          ...
          <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-lg p-6 mt-6">
            ...
            <div className="flex items-center mb-4">
              <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-300 ml-4">Add New News Menu</h3>
            </div>
