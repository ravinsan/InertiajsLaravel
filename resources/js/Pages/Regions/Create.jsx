...
const Create = ({auth, regions}) => {
    ...
    const handleSubmit = (e) => {
      ...
      post(route('regions.store'),{
        onSuccess: () => {
          ...
          toast.success('Region has been created successfully');
        },
        onError: (errors) => {
  ...
  return (
    <AuthenticatedLayout 
          user={auth.user} 
          header={<h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200">Create Region</h2>}
        >
          ...
          <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-lg p-6 mt-6">
            ...
            <div className="flex items-center mb-4">
              <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-300 ml-4">Add New Region</h3>
            </div>
