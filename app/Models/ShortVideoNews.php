...
class ShortVideoNews extends Model
{
    ...
    {
        return $this->belongsTo(ShortVideoCategory::class, 'category_id');
    }

    public function subcategory()
    {
        return $this->belongsTo(ShortVideoSubCategory::class, 'subcategory_id');
    }
